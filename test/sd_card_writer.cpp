...
#define UTF8_FOLDER "Hello.txt"
const char* names[] = {"Hello1.txt", "Hello2.txt", "Hello3.txt", nullptr};
...
#define SD_CONFIG SdSpiConfig(PIN_NSS_SD, DEDICATED_SPI, SD_SCK_MHZ(16), &spi1)
